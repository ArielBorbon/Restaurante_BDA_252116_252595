...
import javax.persistence.Persistence;
     ...
     /*
Este bloque de código define una clase que gestiona la creación de un `EntityManagerFactory`, que es fundamental para la interacción con la base de datos en JPA.

1. Se declara una constante estática `emFactory` que se inicializa utilizando `Persistence.createEntityManagerFactory`, pasando como argumento el nombre de la unidad de persistencia definida en el archivo de configuración (persistence.xml). Este objeto es responsable de crear instancias de `EntityManager`, que se utilizan para realizar operaciones de persistencia.

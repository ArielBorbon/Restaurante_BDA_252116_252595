...
//        
//        
//        Ingrediente ingrediente = em.find(Ingrediente.class, 1L); 
...
//            em.getTransaction().begin();
//
//            // Recuperar el producto con id 2 
//            Producto producto = em.find(Producto.class, 2L);
//
//            // Recuperar los tres ingredientes (1, 2 y 3)

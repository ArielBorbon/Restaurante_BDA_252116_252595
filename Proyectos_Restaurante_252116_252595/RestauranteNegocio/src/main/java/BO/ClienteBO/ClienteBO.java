...
public class ClienteBO implements IClienteBO {
    ...
    public List<Cliente> filtrarClientesReporte(String telefono, String correo) throws NegocioException {
        return clientesDAO.filtrarClientesReporte(telefono, correo);
    }
}
